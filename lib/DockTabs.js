...
class TabCache {
    ...
    render() {
        ...
        let tab = (react_1.default.createElement(DragDropDiv_1.DragDropDiv, { getRef: this.getRef, onDragStartT: onDragStart, role: "tab", "aria-selected": parent.activeId === id, onDragOverT: onDragOver, onDropT: onDrop, onDragLeaveT: onDragLeave, tabData: this.data },
            ...
            tabClosable ?
                react_1.default.createElement(TabCloseBtn, { className: "dock-tab-close-btn", onClick: this.onCloseClick })
                : null,
    ...
    constructor() {
        ...
        this.renderTabBar = (props, TabNavList) => {
            ...
            if (maximizable || showNewWindowButton) {
                ...
                panelDefaultContent = panelData.parent.mode === 'maximize' ? react_1.default.createElement(MinimizeBtn, { className: "dock-panel-min-btn", onClick: handleClick }) : react_1.default.createElement(MaximizeBtn, { className: "dock-panel-max-btn", onClick: handleClick });
            ...
            const renderCollapseExpandBtn = () => {
                if (panelData.collapsed) {
                    return (react_1.default.createElement(ExpandBtn, { className: 'dock-panel-expand-btn', onClick: this.handleCollapseExpandClick }));
                }
                if (isCollapseDisabled) {
                    return (react_1.default.createElement(CollapseBtn, { className: 'dock-panel-collapse-btn dock-panel-collapse-btn-disabled' }));
                }
                return (react_1.default.createElement(CollapseBtn, { className: 'dock-panel-collapse-btn', onClick: this.handleCollapseExpandClick }));
            };
            const renderToggleFloatingBtn = () => {
                return (react_1.default.createElement(ToggleFloatingBtn, { className: panelData.parent.mode === 'float' ? 'dock-panel-restore-floating-btn' : 'dock-panel-make-floating-btn', onClick: this.handleToggleFloatingClick }));
            };
            panelExtraContent = react_1.default.createElement(react_1.default.Fragment, null,
                ...
                panelDefaultContent,
                panelData.tabs.length === 1 && panelData.tabs[0].closable && react_1.default.createElement(PanelCloseBtn, { className: "dock-panel-close-btn", onClick: this.handlePanelCloseClick }));
