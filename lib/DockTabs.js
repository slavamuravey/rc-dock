...
class TabCache {
    ...
    render() {
        ...
        let tab = (react_1.default.createElement(DragDropDiv_1.DragDropDiv, { getRef: this.getRef, onDragStartT: onDragStart, role: "tab", "aria-selected": parent.activeId === id, onDragOverT: onDragOver, onDropT: onDrop, onDragLeaveT: onDragLeave, tabData: this.data },
            ...
            tabClosable ?
                react_1.default.createElement(TabCloseButton, { className: "dock-tab-close-btn", onClick: this.onCloseClick })
                : null,
    ...
    constructor() {
        ...
        this.renderTabBar = (props, TabNavList) => {
            ...
            if (maximizable || showNewWindowButton) {
                ...
                panelDefaultContent = panelData.parent.mode === 'maximize' ? react_1.default.createElement(MinimizeButton, { className: "dock-panel-min-btn", onClick: handleClick }) : react_1.default.createElement(MaximizeButton, { className: "dock-panel-max-btn", onClick: handleClick });
            ...
            const renderCollapseExpandBtn = () => {
                if (panelData.collapsed) {
                    return (react_1.default.createElement(ExpandButton, { className: 'dock-panel-expand-btn', onClick: this.handleCollapseExpandClick }));
                }
                if (isCollapseDisabled) {
                    return (react_1.default.createElement(CollapseButton, { className: 'dock-panel-collapse-btn dock-panel-collapse-btn-disabled' }));
                }
                return (react_1.default.createElement(CollapseButton, { className: 'dock-panel-collapse-btn', onClick: this.handleCollapseExpandClick }));
            };
            const renderToggleFloatingBtn = () => {
                return panelData.parent.mode === 'float' ? (react_1.default.createElement(RestoreFloatingButton, { className: 'dock-panel-restore-floating-btn', onClick: this.handleToggleFloatingClick })) : (react_1.default.createElement(MakeFloatingButton, { className: 'dock-panel-make-floating-btn', onClick: this.handleToggleFloatingClick }));
            };
            panelExtraContent = react_1.default.createElement(react_1.default.Fragment, null,
                ...
                panelDefaultContent,
                panelData.tabs.length === 1 && panelData.tabs[0].closable && react_1.default.createElement(PanelCloseButton, { className: "dock-panel-close-btn", onClick: this.handlePanelCloseClick }));
