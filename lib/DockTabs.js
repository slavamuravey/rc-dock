...
class TabCache {
    ...
    render() {
        ...
        const tabGroup = Utils_1.mergeTabGroups(this.context.getGroup(group), localGroup);
        ...
        let tab = (react_1.default.createElement(DragDropDiv_1.DragDropDiv, { getRef: this.getRef, onDragStartT: onDragStart, role: "tab", "aria-selected": parent.activeId === id, onDragOverT: onDragOver, onDropT: onDrop, onDragLeaveT: onDragLeave, tabData: this.data },
            ...
            tabClosable ?
                react_1.default.createElement("div", { className: "dock-tab-close-btn", onClick: this.onCloseClick, onMouseDown: this.onClosePointerDown, onTouchStart: this.onClosePointerDown }, tabCloseButton)
                : null,
...
class DockTabs extends react_1.default.PureComponent {
    constructor() {
        ...
        this.renderTabBar = (props, TabNavList) => {
            ...
            if (maximizable || showNewWindowButton) {
                ...
                panelDefaultContent = panelData.parent.mode === 'maximize' ? (react_1.default.createElement("div", { className: "dock-panel-min-btn", onClick: handleClick }, minimizeButton)) : (react_1.default.createElement("div", { className: "dock-panel-max-btn", onClick: handleClick }, maximizeButton));
            ...
            const renderCollapseExpandBtn = () => {
                if (panelData.collapsed) {
                    return (react_1.default.createElement("div", { className: 'dock-panel-expand-btn', onClick: this.handleCollapseExpandClick }, expandButton));
                }
                if (isCollapseDisabled) {
                    return (react_1.default.createElement("div", { className: 'dock-panel-collapse-btn dock-panel-collapse-btn-disabled' }, collapseButton));
                }
                return (react_1.default.createElement("div", { className: 'dock-panel-collapse-btn', onClick: this.handleCollapseExpandClick }, collapseButton));
            };
            const renderToggleFloatingBtn = () => {
                return panelData.parent.mode === 'float' ? (react_1.default.createElement("div", { className: 'dock-panel-restore-floating-btn', onClick: this.handleToggleFloatingClick }, restoreFloatingButton)) : (react_1.default.createElement("div", { className: 'dock-panel-make-floating-btn', onClick: this.handleToggleFloatingClick }, makeFloatingButton));
            };
            panelExtraContent = react_1.default.createElement(react_1.default.Fragment, null,
                ...
                panelData.tabs.length === 1 &&
                    ...
                    react_1.default.createElement("div", { className: "dock-panel-close-btn", onClick: this.handlePanelCloseClick }, panelCloseButton));
            return (react_1.default.createElement(react_1.default.Fragment, null,
                panelData.id !== DockData_1.maximePlaceHolderId ? extraBar : null,
                react_1.default.createElement(DockTabBar_1.DockTabBar, Object.assign({ onDragStart: onPanelDragStart, onDragMove: onPanelDragMove, onDragEnd: onPanelDragEnd, TabNavList: TabNavList, isMaximized: panelData.parent.mode === 'maximize' }, props, { extra: panelExtraContent, panelData: panelData }))));
        };
    ...
    render() {
        ...
        let tabGroup = Utils_1.mergeTabGroups(this.context.getGroup(group), localGroup);
        let { animated, moreTabsButton = this.context.moreTabsButton } = tabGroup;
        if (animated == null) {
            animated = true;
        }
        if (this.animationDisabled) {
        ...
        return (react_1.default.createElement(rc_tabs_1.default, { prefixCls: classnames_1.default(this.context.getClassName(), "dock"), moreIcon: moreTabsButton, animated: animated, renderTabBar: this.renderTabBar, activeKey: activeId, tabPosition: tabPosition, onChange: this.onTabChange }, children));
    }
}
